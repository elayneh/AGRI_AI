export const Services = [
  ...
  {
    title: "Live Stream Interviews",
    body: "Break free from geographical constraints with our WebRTC-powered live stream interview feature. Recruiters can interact with top candidates in real-time, providing a dynamic and efficient hiring process. Elevate your recruitment experience by conducting interviews remotely, streamlining the entire hiring process.",
  },
];
